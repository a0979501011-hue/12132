/**
 * Helper utility to resize and compress pictures directly on the client side.
 * Converts any image file into a lightweight base64 JPEG string (typically < 50KB).
 */
